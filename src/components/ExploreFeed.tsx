          ...
          <div className="flex items-center gap-2 rounded-lg border border-line-strong bg-surface px-3 transition-colors focus-within:border-brand-500 focus-within:ring-3 focus-within:ring-brand-soft">
            ...
            {searchQuery && (
              <button
                ...
                className="grid h-6 w-6 place-items-center rounded-md text-muted transition-colors hover:bg-surface-muted hover:text-ink pointer-coarse:min-h-[44px] pointer-coarse:min-w-[44px]"
              >
                <X className="h-4 w-4" />
              </button>
            )}
