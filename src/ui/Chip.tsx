...
export function FilterChip({
  ...
  return (
    <button
      ...
      className={`inline-flex h-9 min-w-9 shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-full border px-3 text-label font-bold pointer-coarse:min-h-[44px] pointer-coarse:px-3.5 transition-colors duration-150 ${
        selected
